      ...
      <!--페이지네이션  -->
       <!--  <nav class="pagination-wrap" aria-label="Page navigation example">
        ...
        <ul class="pagination justify-content-center">
          <li id="prev-btn" class="page-item" data-page="prev">
        ...
        <c:forEach begin="${beginPage}" end="${endPage}" var="page"> 
          ...
          <li id="next-btn" class="page-item" data-page="next">
            <a class="page-link" href="#">
          ...
          var currentPage = ${pageNo}; 
            $(".page-item").click((e) => {
              ...
              if(page == "prev") {
                  if(currentPage == 1)
                  return; 
                 var test = "?pageNo=" + (currentPage -1) + "&pageSize=" + ${pageSize};
                  $.get("../json/faq/list" + test, function(data){
                    console.log(data);
                ...
                var test = "?pageNo=" + page + "&pageSize=" + ${pageSize};
                $.get("../json/faq/list" + test, function(data){
                  console.log(data);
                  var list = data.result.faqs;
                  var tableTag ="";
