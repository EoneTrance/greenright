                        ...
                        <div class="text py-3 pb-4 px-3 text-center">
                            ...
                            <div class="bottom-area d-flex px-3">
                                <div class="m-auto d-flex">
                                    <a href="#" class="fa-comment d-flex justify-content-center align-items-center text-center">
                                        <i class="fas fa-comments"></i>
                                    </a>
                                    <a href="#" class="add-to-cart d-flex justify-content-center align-items-center mx-1" data-productNo="${product.no}">
