  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 product-details pl-md-5 ftco-animate">
            ...
            <div class="form-group d-flex">
              <div class="select-wrap">
                ...
                <c:forEach items="${product.options}" var="option">
                  <select name="" id="my-option" class="form-control">
        ...
        <p>
          <a id="my-add-cart" href="cart.html" class="btn btn-black py-3 px-5">Add to
            Cart</a>
        </p>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row justify-content-center mb-3 pb-3">
      <div class="col-md-12 heading-section text-center ftco-animate">
        ...
        <h2 class="mb-4">같은카테고리의 상품 추천</h2>
      </div>
    </div>
  </div>
  <div class="container">
...
<script>
$('#my-add-cart').click(function(e){
  e.preventDefault();
  var a = $('#my-option option:selected').val();
  var b = $('#quantity').val();
  var param = "productNo="+${productNo}+"&optionItemNo="+a+"&quantity="+b;
  $.ajax({
