...
<form action='update' method='post' enctype='multipart/form-data' onsubmit="return checkState()">
  <table class="table table-bordered table-hover" style="margin:auto auto;text-align:left;">
    ...
    <tr>
      <th>비밀번호</th>
      <td>
      <input type="button" class="form-control input-lg my-essential btn-success" value="비밀번호 변경"/>
      <input type="password" name="password" class="form-control input-lg my-essential" maxlength="12" autocomplete="off" style="display:none;"/>
      <div class="inputState"></div>
      <input type="password" name="confirmPassword" class="form-control input-lg my-essential" maxlength="12" autocomplete="off" style="display:none;"/>
      <div class="inputState"></div>
    </td>
    <tr>
      <th>이름</th>
    ...
    <tr id="address">
      <th>우편번호</th>
      <td>
      <input type="text" class="form-control input-lg my-essential"
             id="sample3_postcode" name="postalCode" value='${loginUser.postalCode}'
             readonly style="background-color:#E1E1E1;">
      <input type="button" class="form-control input-lg my-essential" name="searchPostalCode"
    ...
    <tr>
      ...
      <input type="text" id="sample3_address" name="defaultAddress"
             class="form-control input-lg my-essential" value='${loginUser.defaultAddress}'
    ...
    <tr>
      ...
      <input type="text" id="sample3_detailAddress" name="detailAddress"
             class="form-control input-lg my-essential" value='${loginUser.detailAddress}'
  ...
  <button class="btn btn-lg btn-success btn-block signup-btn" type="submit">회원정보 수정</button>
</form>
</div>
...
$("#memberInfoForm")[0].addEventListener("focusout", function(e) {
  ...
  if ((e.target.tagName != "BUTTON" || e.target.type != "button") && e.target.className.indexOf("notChange") == -1) {
    console.log(e.target.className.indexOf("notChange"));
...
function changePassword() {
  $("input[name=password]")[0].display = "inline-block";
  $("input[name=confirmPassword]")[0].display = "inline-block";
}
</script>