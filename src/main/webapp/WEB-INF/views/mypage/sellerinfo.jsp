  ...
  <div class="row">
    ...
    <div class="my-col-80">
      ...
      <form class="text-center" action='../seller/update' method='post' onsubmit="return checkState()">
        ...
        <hr>
        <button class="btn btn-lg btn-primary btn-inline-block signup-btn mr-1" style="width:100%;" type="submit">수정</button>
      </form>
      </div>
    </div>
  </div>
...
if(${loginUser.memberClass} == 2) {
  $("#infoMenu").append(
      "<li class='my-menu active'><a href='sellerinfo'>판매정보</a></li>");
  $("#sellerMenu").append(
