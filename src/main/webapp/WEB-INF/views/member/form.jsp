...
<form action='join' method='post' enctype='multipart/form-data' onsubmit="return checkState()">
    아이디 <input type="text" name="id" class="form-control input-lg my-essential" maxlength="12"/>
    ...
    <div class="inputState"></div><br>
    이름 <input type="text" name="name" class="form-control input-lg my-essential" />
    <div class="inputState"></div><br>
    이메일 <input type="email" name="email" class="form-control input-lg my-essential" placeholder="입력하신 메일 주소로 인증메일이 발송됩니다."/>
    <div class="inputState"></div><br>
    핸드폰 번호 <input type="text" name="cellPhone" class="form-control input-lg my-essential" maxlength="11"/>
    <div class="inputState"></div><br>
    <div id="address">
      우편번호<br>
      ...
      <input type="text" id="sample3_address" name="defaultAddress"
             class="form-control input-lg my-essential"
             readonly style="background-color:#E1E1E1;text-align:left;">
      <div class="inputState"></div><br>
      상세주소<br>
      <input type="text" id="sample3_detailAddress" name="detailAddress"
             class="form-control input-lg my-essential" style="text-align:left;">
      <div class="inputState"></div><br>
    </div>
    본인 확인 질문 <select name="question" class="form-control input-lg my-essential">
    ...
    <div class="inputState"></div><br>
    본인 확인 답변 <input type="text" name="answer" class="form-control input-lg my-essential" />
