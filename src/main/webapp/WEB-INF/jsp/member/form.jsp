...
<html lang="en">
  ...
  <body>
    ...
    <div id=content>
      <div id=signform>
    <!-- name="Member" class="form" role="form" -->
      <form action='join' method='post' enctype='multipart/form-data' onsubmit="return checkEmpty()">
        <!-- <div class="row">
          <div class="col-xs-6 col-md-6"> -->
          아이디 <input type="text" name="id" class="form-control input-lg" maxlength="12"/>
          ...
          이름 <input type="text" name="name" class="form-control input-lg" />
          <div></div><br>
          이메일 <input type="email" name="email" class="form-control input-lg" placeholder="입력하신 메일 주소로 인증메일이 발송됩니다."/>
          <div id="checkEmail"></div><br>
          핸드폰 번호 <input type="text" name="cellPhone" class="form-control input-lg" maxlength="11"/>
          <div></div><br>
          <div id="address">
            우편번호<br>
            <input type="text" class="form-control input-lg"
                   ...
                   text-align:left;">
            <input type="button" class="form-control input-lg" name="searchPostalCode"
            ...
            <!--
            <input type="text" id="sample3_extraAddress" name="extraAddress"
                   class="btn btn-block"
                   readonly style="background-color:#E1E1E1;text-align:left;">
            -->
            <div></div><br>
            ...
            <input type="text" id="sample3_detailAddress" name="detailAddress"
                   class="form-control input-lg" style="text-align:left;">
            <div></div><br>
          </div>
          계정 찾기 질문 <select name="question" class="form-control input-lg">
          ...
          <div></div><br>
          계정 찾기 답변 <input type="text" name="answer" class="form-control input-lg" />
          <div></div><br>
    ...
    $("#signform")[0].addEventListener("focusout", function(e) {
      ...
      if (e.target.tagName != "BUTTON") {
        ...
        if (e.target.value == "" || e.target.value == "질문 유형 선택"){
          ...
          if (e.target.name == "id") {
            if (!regularId.test($(getTagNameByName)[0].value)) {
              ...
              $.ajax({
                ...
                data: "value=" + $(getTagNameByName)[0].value,
                dataType: "json",
                async: true,
            ...
            if (!regularNumber.test(e.target.value)) {
              $(getTagNameByName)[0].style = "border: solid red 3px; background-color:#FFF9F9;";
              $(getConditionTag)[0].style = "color:red; font-size:80%;";
              $(getConditionTag)[0].innerHTML = "숫자만 입력하실 수 있습니다.";
              e.stopPropagation();
            } else {
              $.ajax({
                type: "GET",
          ...
          } else if (e.target.value != "" || e.target.value != "질문 유형 선택") {
