...
/* 추가  */
    ...
    .col-md-7.heading-section.ftco-animate.text-center.fadeInUp.ftco-animated.faq {
    margin: auto;
    width: 700px;
    }    
  
    .about-author.d-flex.p-4.bg-light.faq {
    /* margin: auto; */
    margin-top: 50px;
    margin-bottom: 50px;
    }
    ...
    input.btn.btn-primary.submit.px-3.faq {
...
<body>
  ...
  <div id="entire">
    ...
    <div class=" contents about-author d-flex p-4 bg-light faq">
      <div  id ="faqheader" class="col-md-7 heading-section ftco-animate text-center fadeInUp ftco-animated faq">
