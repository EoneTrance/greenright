...
<div id='contnet'>
  <form>
    ...
    <div  style="text-align:center">
      <!-- <button type="button" class="btn btn-outline-success border border-success ">1대1 문의작성</button> -->
      <a href="privatequestionadd" class="btn btn-outline-success border border-success " role="button" aria-pressed="true">1대1 문의 작성</a>
    </div>
  </form>
</div>
