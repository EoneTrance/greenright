...
public class BoardController {
  ...
  public void list(@RequestParam(defaultValue = "1") int pageNo,
      @RequestParam(defaultValue = "5") int pageSize, Model model, String type, String keyword,
  ...
  public String update(HttpServletRequest request, Board board, MultipartFile[] filePath,
      String boardPhotoNumber[]) throws Exception {
  ...
  public String commentupdate(@RequestParam(value = "contents", required = false) String contents,
      @RequestParam(value = "commentNo", required = false) String commentNo) throws Exception {
