...
CREATE TABLE members (
  ...
  member_class       INTEGER      NOT NULL DEFAULT 1 COMMENT '회원구분', -- 회원구분
  ...
  certification_flag BOOLEAN      NOT NULL DEFAULT 0 COMMENT '인증여부', -- 인증여부
  ...
  authkey            VARCHAR(255) NULL     COMMENT '회원가입인증키', -- 회원가입인증키
  password_authkey   VARCHAR(255) NULL     COMMENT '비밀번호인증키' -- 비밀번호인증키
)
COMMENT '회원';
...
CREATE TABLE sellers (
  ...
  account_num    VARCHAR(50) NOT NULL COMMENT '판매자계좌번호', -- 판매자계좌번호
  account_holder VARCHAR(50) NOT NULL COMMENT '예금주 명', -- 예금주 명
  tel            VARCHAR(50) NOT NULL COMMENT '고객응대전화번호', -- 고객응대전화번호
  point          INTEGER     NOT NULL DEFAULT 0 COMMENT '판매포인트' -- 판매포인트
)
COMMENT '판매회원';
...
CREATE TABLE baskets (
  member_id       INTEGER NOT NULL COMMENT '회원번호', -- 회원번호
  option_item_id  INTEGER NOT NULL COMMENT '옵션항목번호', -- 옵션항목번호
  registered_date DATE    NOT NULL COMMENT '등록일', -- 등록일
...
CREATE TABLE option_items (
  option_item_id      INTEGER      NOT NULL COMMENT '옵션항목번호', -- 옵션항목번호
  options_id          INTEGER      NOT NULL COMMENT '옵션번호', -- 옵션번호
  option_item_matters VARCHAR(255) NOT NULL COMMENT '옵션항목사항', -- 옵션항목사항
  options_price       INTEGER      NOT NULL COMMENT '옵션가격', -- 옵션가격
  options_quantity    INTEGER      NOT NULL COMMENT '옵션수량' -- 옵션수량
)
COMMENT '옵션항목';
...
CREATE TABLE comments (
  comments_id  INTEGER       NOT NULL COMMENT '댓글번호', -- 댓글번호
  created_date DATE          NOT NULL COMMENT '작성일', -- 작성일
  contents     VARCHAR(2000) NOT NULL COMMENT '내용', -- 내용
  member_id    INTEGER       NOT NULL COMMENT '회원번호', -- 회원번호
  boards_id    INTEGER       NOT NULL COMMENT '게시판번호' -- 게시판번호
